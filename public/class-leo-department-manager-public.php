 ...
 * @subpackage Leo_Department_Manager/public
 */
 ...
 */
class Leo_Department_Manager_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/leo-department-manager-public.css', array(), $this->version, 'all' );
